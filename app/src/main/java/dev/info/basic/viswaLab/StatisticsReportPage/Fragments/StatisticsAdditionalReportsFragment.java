 ...
 */
public class StatisticsAdditionalReportsFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        textView.setText("Additional Tests Statistics");
    ...
    private void fetchDetails() {
        ...
        apiInterface.GetStatisticsAdditionalReports(prefs.getString("userid", ""), new Callback<JsonObject>() {
            @Override
