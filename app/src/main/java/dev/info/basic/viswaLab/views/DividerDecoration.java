package dev.info.basic.viswaLab.views;
...
/**
 * <h1>DividerDecoration</h1>
 *
 * @author E5000096
 * @since 10-03-2016
 *
 * <b>Copyright Information:</b> Copyright (c) Innovapptive  Inc. 2016 - All Rights Reserved.
 */
public class DividerDecoration extends RecyclerView.ItemDecoration {

    private static final int[] sATTRS = new int[]{
            android.R.attr.listDivider
    };

    public static final int sVERTICAL_LIST = LinearLayoutManager.VERTICAL;
    ...
    public DividerDecoration(Context context) {
        final TypedArray a = context.obtainStyledAttributes(sATTRS);
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        if (getOrientation(parent) == sVERTICAL_LIST) {
