 ...
 */
public class StatisticsPOMPReportsFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        textView.setText("POMP Statistics");
    ...
    private void fetchDetails() {
        ...
        apiInterface.GetStatisticsPOMPReports(prefs.getString("userid", ""), new Callback<JsonObject>() {
            @Override
